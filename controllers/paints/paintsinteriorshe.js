...
const sheetId = "1INMAuXgBJsa7xZ0u5zU3Y2hjf9beY6bNfaPFGHX0FpU";
const range = "InteriorData!A:D";

// Utility function to fetch all interior data
const fetchPaintsInteriorData = async () => {
    try {
...
const updatePaintsInteriorData = async (req, res) => {
    ...
    try {
        const rows = await fetchPaintsInteriorData();
...
const sendPaintsInteriorData = async (req, res) => {
    const { name, email, phonenumber, address } = req.body;
...
const getPaintsInteriorData = async (req, res) => {
    try {
        const rows = await fetchPaintsInteriorData();
        if (!rows.length) {
...
const deletePaintsInteriorData = async (req, res) => {
    const { name } = req.body;
...
// Export functions
module.exports = { sendPaintsInteriorData, getPaintsInteriorData, deletePaintsInteriorData, fetchPaintsInteriorData, updatePaintsInteriorData };
