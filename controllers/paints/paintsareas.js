...
const fetchPaintsAllAreas = async () => {
    try {
...
const sendPaintsAllAreas = async (req, res) => {
    const { name } = req.body;
    ...
    try {
        ...
        const existingAreas = await fetchPaintsAllAreas();
...
const getPaintsAllAreas = async (req, res) => {
    try {
        const rows = await fetchPaintsAllAreas();
        if (!rows.length) {
...
const deletePaintsAreasData = async (req, res) => {
    const { name } = req.body;
...
module.exports = { deletePaintsAreasData, fetchPaintsAllAreas, sendPaintsAllAreas, getPaintsAllAreas }