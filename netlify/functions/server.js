...
const { addNewProduct, deleteSingleProduct, updateSingleProduct, getSingleProducts, addImportedProducts, updateProductsToSheet } = require("../../controllers/sheets/Product Sheets/productsheets");
...
app.post("/.netlify/functions/server/updateProductFromSheet", updateProductsToSheet);
